...
export class TaskActivityComponent implements OnInit {
  ...
  popupVisibleAddTask: boolean = false;
  popupVisibleAddActivity: boolean = false;
  ...
  constructor(private codeservice: CodeService, private setting: AppSettingsService) {
    this.Initialize();
  }
  ...
  GetAllTask() {
    this.codeservice.GetAllCodeList(this.setting.getBaseUrl() + GLOBAL.API_TaskAndActivity_GetAllTask).subscribe(
      data => {
        this.allTaskArr = [];
  ...
  GetAllActivity() {
    this.codeservice.GetAllCodeList(this.setting.getBaseUrl() + GLOBAL.API_TaskAndActivity_GetAllActivity).subscribe(
      data => {
        this.allActivityArr = [];
